...
const Client_Router_Ads = require("./client_Ads.routes");
const Client_Router_Partner = require("./client_Partner.routes");
Router.use(Client_Router_Partner);
Router.use(Client_Router_Ads);
